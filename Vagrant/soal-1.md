...
1. Melakukan pengecekan apakah provisioning berhasil dengan cara masuk ke dalam virtualisasi menggunakan
    ...
    ![Tampilan biasa](https://github.com/nahdazahra/cloud2018/blob/master/Vagrant/assets/tampilan1.png)
    ...
    ![Daftar user](https://github.com/nahdazahra/cloud2018/blob/master/Vagrant/assets/daftar-user.png)
...
2. Untuk masuk ke dalam ```user awan```, ketikkan
    ...
    ![Daftar user](https://github.com/nahdazahra/cloud2018/blob/master/Vagrant/assets/user-awan.png)
...
![Tampilan luar biasa](https://github.com/nahdazahra/cloud2018/blob/master/Vagrant/assets/tampilan2.png)
...
1. Jika belum dibuat **user awan** dan **password buayakecil** pada vagrant virtualbox, namun sudah meng-config ```ssh.username``` dan ```ssh.password```, hasilnya selalu gagal
    ...
    ![Kendala](https://github.com/nahdazahra/cloud2018/blob/master/Vagrant/assets/kendala.png)
